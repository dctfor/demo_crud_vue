              ...
              <div class="col-md-7 col-sm-12 my-1">
                <ul class="list-group">
                  <li class="list-group-item">
                    Name:
                    <span id="s-Name" class="fw-bold">{{ contact.name }}</span>
                  </li>
                  <li class="list-group-item">
                    Email:
                    <span id="s-Email" class="fw-bold">{{
                      contact.email
                    }}</span>
                  </li>
                  <li class="list-group-item">
                    Mobile:
                    <span id="s-Mobile" class="fw-bold">{{
                      contact.mobile
                    }}</span>
                  </li>
                  <li class="list-group-item">
                    Company:
                    <span id="s-Company" class="fw-bold">{{
                      contact.company
                    }}</span>
                  </li>
                  <li class="list-group-item">
                    Title:
                    <span id="s-Title" class="fw-bold">{{
                      contact.title
                    }}</span>
                  </li>
                  <li class="list-group-item">
                    Department:
                    <span id="s-Group" class="fw-bold">{{ department }}</span>
                  </li>
                </ul>
              </div>
            </div>
