<template>
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary" v-if="isNotLogin">
    <a class="navbar-brand" href="#">VUE CRUD Example</a>
    <button
      ...
      <ul class="navbar-nav">
        <li class="nav-item active">
          <button
            ...
            @click="clear"
          >
            New Contact<span class="sr-only">(current)</span>
          </button>
        </li>
        <li class="nav-item">
          <button
        ...
        <li class="nav-item">
          <a class="nav-link" href="#" @click="logout()"><b>LogOut</b></a>
        </li>
      </ul>
    </div>
  </nav>
...
export default {
  ...
  computed: {
    isNotLogin() {
      return !["LoginForm"].includes(this.$route.name);
    },
  },
  methods: {
    logout: function () {
